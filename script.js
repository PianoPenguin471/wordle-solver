...
function findWords() {
    ...
    valid_words = NegativePositionalFilter(valid_words);
    console.log(valid_words);
    valid_words = DoesntContainFilter(valid_words); 
    console.log(valid_words);
...
function ContainsFilter(words, positive_letters) {
    console.log(positive_letters);
    if (!positive_letters) return words;

    var valid_words = [];
    words.forEach(element => {
        all_hit = true;
        for (i = 0; i < positive_letters.length; i++) {
            positive_letter = positive_letters[i];
            if (!element.includes(positive_letter)) {
                all_hit = false;
            }
        }
        if (all_hit) {
